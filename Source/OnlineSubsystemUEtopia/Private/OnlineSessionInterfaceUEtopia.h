 ...
 */
class FOnlineSessionUEtopia : public IOnlineSession
{
private:
	...
	*/
	 ...
	 */
	void AppendSessionToPacket(class FNboSerializeToBufferUEtopia& Packet, class FOnlineSession* Session);
	 ...
	 */
	void AppendSessionSettingsToPacket(class FNboSerializeToBufferUEtopia& Packet, FOnlineSessionSettings* SessionSettings);
	 ...
	 */
	void ReadSessionFromPacket(class FNboSerializeFromBufferUEtopia& Packet, class FOnlineSession* Session);
	 ...
	 * @param SessionSettings the session settings to copy the data to
	 */
	void ReadSettingsFromPacket(class FNboSerializeFromBufferUEtopia& Packet, FOnlineSessionSettings& SessionSettings);
	 ...
	 */
	static void SetPortFromNetDriver(const FOnlineSubsystemUEtopia& Subsystem, const TSharedPtr<FOnlineSessionInfo>& SessionInfo);
...
PACKAGE_SCOPE:
	...
	FOnlineSessionUEtopia(class FOnlineSubsystemUEtopia* InSubsystem) :
